...
namespace dickyermawan\admin\controllers;

use Yii;
use dickyermawan\admin\models\User;
use dickyermawan\admin\models\AuthAssignment;
use dickyermawan\admin\models\AuthItem;
use dickyermawan\admin\models\UserSearch;
...
class UserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if ($model->load(Yii::$app->request->post())) {
			...
			if ($model->save()) {
				Yii::$app->session->setFlash('success', 'User berhasil dibuat dengan password 1234');
			} else {
